...
extension Array where Element == Top {
    mutating func addAll(list: [Top]?, clear: Bool) {
        if clear { self.removeAll() }
...
extension Array where Element == Chat {
    mutating func addAll(list: [Chat]?, clear: Bool) {
        if clear { self.removeAll() }
...
extension Array where Element == InvitationCard {
    mutating func addAll(list: [InvitationCard]?, clear: Bool) {
        if clear { self.removeAll() }
...
extension Array where Element == Like {
    mutating func addAll(list: [Like]?, clear: Bool) {
        if clear { self.removeAll() }
